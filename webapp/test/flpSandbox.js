		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdemozsdordersnw-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemozsdordersnw-display": {
								"semanticObject": "comdemozsdordersnw",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.zsdordersnw",
									"url": sap.ui.require.toUrl("com/demo/zsdordersnw")
								}
							}
						}
					}
